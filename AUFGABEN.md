...
| AP5-06 | Gegner-Klassen (Normal/Schnell-Schwach/Langsam-Stark) | ✅ `erledigt/` (`e878a64`) |
...
| AP6-02b | Bresche → Durchbruch → Linienfall (physisch, telegraphiert) + Uhr-Regel (Golden-Rebaseline hier) | offen (nächstes) |
