# Sparring-Log — Verlauf der Briefings

Chronik der `SPARRING.md`-Versionen, die an externe KIs gegeben wurden. `SPARRING.md`
selbst hält immer nur die **aktuelle** Fassung; hier steht, was vorher verschickt
wurde und wo die Antworten liegen. Neueste Version oben.
...
## v1 — 2026-09-03 — Gesamtkonzept-Sparring (15 Themen)

Erstes Briefing. Breit angelegt: Design, Technik, Priorisierung. Antworten von
Gemini, Perplexity und ChatGPT liegen in `SPARRING-ANTWORTEN.md` inkl.
Konvergenz-Analyse. Kernergebnisse, auf denen v2 aufbaut:

- Map nicht vollprozedural → authored Module + prozedurales Makrolayout.
- Pathing = semantischer Graph aus den Modulen, kein NavMesh.
- Gegner-KI: 3 Verhalten reichen (Charger · Suppressor · Disruptor).
- Der Rückzugs-Loop ist Alleinstellungsmerkmal **und** größter Risiko-Klumpen.
- In-Mission-Quest als Dauermechanik streichen.
- Nachschub: eine Währung + Budgets/Slots statt zwei Währungen.
- Jetzt kein Netcode, keine Art-/Bundle-Optimierung.
- Tag/Nacht ist der größte Scope-Multiplikator — nicht beide Roster parallel bauen.

<details>
<summary>Vollständiger Wortlaut v1</summary>
